...
## 리그 시스템 (4리그 × 10레벨 = 총 40레벨)
- 화이트 리그 (레벨 1~10): 복싱 입문자. 기본기를 배우는 단계
- 블루 리그 (레벨 11~20): 기본기를 갖춘 복싱인. 콤비네이션과 디펜스 훈련
- 레드 리그 (레벨 21~30): 실전 복서. 스파링과 고급 기술 훈련
- 블랙 리그 (레벨 31~40): 마스터급. 모든 기술을 갖춘 복서

## 레벨업 방식
- 메인 퀘스트: 코치가 인증하는 핵심 훈련 과제
- 서브 퀘스트: 보조 훈련 및 체력 단련
- 주간 퀘스트: 매주 새로운 도전 과제
- 보스전 (타이틀매치): 각 리그 레벨 10에서 치르는 리그 승격 시험. 클리어하면 다음 리그로!
...
## 앱 주요 기능
- 홈: 내 리그, 순위, 추격 대상, 오늘의 퀘스트
- 퀘스트: 도전할 수 있는 미션 목록
- 리그맵: 화이트~블랙 40레벨 전체 맵
