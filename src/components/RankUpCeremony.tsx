    ...
    if (isOpen) {
      ...
      const frame = () => {
        confetti({
          ...
          spread: 80,
          origin: { x: 0, y: 0.6 },
          colors: ["#E8553A", "#F5A623", "#FFD700", "#4CAF50"],
        });
        confetti({
          particleCount: 5,
          angle: 120,
