          ...
          {rows.map((r) => (
            <li key={r.plan_id}>
              <button
                ...
                className="flex w-full items-center gap-2 rounded-xl border border-border bg-background px-3 py-2 text-left active:scale-[0.99]"
              >
