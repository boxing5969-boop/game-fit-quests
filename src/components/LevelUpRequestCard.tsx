// 레벨 진행 카드 — 출석 기반 승급 (2026-09-07 리그별 차등 개편).
//
// 얼굴 인식 출석이 리그 요건(화이트3·블루5·레드8·블랙20회)만큼 쌓이면:
//   · 화이트·블루 1~9레벨 → 자동 승급 (+50XP, 💎+10). 회원이 누를 버튼이 없다.
//   · 레드·블랙          → 승급 심사함에 자동 신청 (출석만으로는 절대 안 올라간다)
//   · 10레벨             → 코치 승인함에 자동 신청 (승급은 코치의 approve_level_review 만 가능)
//   · 블랙               → 레벨마다 최소 45일 연한까지 채워야 한다
