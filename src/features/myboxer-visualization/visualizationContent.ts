...
export const VISUALIZATION_SESSION: VisualizationSession = {
  ...
  subtitle: "성인 회원용 3분 1라운드 시각화 훈련",
  durationSeconds: 180,
  openingText:
    "오늘 당신은 단순히 운동하러 온 것이 아닙니다.\n153복싱짐으로 돌아와,\n복싱인이 되어가는 자신을 먼저 마음속에서 만납니다.",
  closingDeclaration:
  ...
  segments: [
    {
      ...
      title: "돌아온 사람",
      guide: "눈을 천천히 감고, 오늘 이곳까지 온 자신을 인정합니다.",
      narration:
        "하루가 길었습니다.\n몸은 조금 무겁고, 머릿속에는\n아직 정리되지 않은 생각들이 남아 있습니다.\n\n그래도 당신은 멈추지 않았습니다.\n오늘 당신은 다시 153복싱짐으로 돌아왔습니다.",
    },
    {
      id: 2,
      start: 15,
      ...
      title: "문 앞의 빛",
      guide: "153복싱짐 문 앞에 서 있는 장면을 떠올립니다.",
      narration:
        "153복싱짐 문 앞에 서 있습니다.\n안쪽에서 따뜻한 빛이 새어 나옵니다.\n\n줄넘기 소리, 샌드백이 흔들리는 소리,\n누군가의 짧은 호흡이 들립니다.\n그 소리들이 말합니다.\n당신은 다시 시작할 수 있다고.",
    },
    {
      ...
      title: "하루를 내려놓는 순간",
      guide: "어깨와 턱의 힘을 천천히 뺍니다.",
      narration:
        "문을 열기 전,\n어깨에 쌓인 하루의 무게를 내려놓습니다.\n\n일, 걱정, 피로, 스트레스는 잠시 밖에 둡니다.\n지금부터의 시간은 누군가를 위한 시간이 아니라,\n당신 자신을 위한 시간입니다.",
    },
    {
      id: 4,
      start: 45,
      ...
      title: "준비의 의식",
      guide: "손을 준비하는 모습을 천천히 상상합니다.",
      narration:
        "손을 준비합니다.\n손목을 감싸고, 손가락 사이를 지나고,\n주먹을 가볍게 쥡니다.\n\n이것은 단순한 준비가 아닙니다.\n오늘의 나를 지키겠다는 작은 의식입니다.\n몸이 훈련을 기억하기 시작합니다.",
    },
    {
      id: 5,
      start: 60,
      ...
      narration:
        "거울 앞에 섭니다.\n거울 속의 당신은 완벽한 복서가 아닙니다.\n\n하지만 도망치지 않고 돌아온 사람입니다.\n예전보다 조금 더 단단해지고 싶은 사람입니다.\n그 모습이면 충분합니다.",
    },
    {
      id: 6,
      start: 75,
      ...
      title: "자세가 마음을 세운다",
      guide: "발을 단단히 놓고, 턱을 살짝 당깁니다.",
      narration:
        "발을 안정되게 놓습니다.\n턱을 살짝 당기고, 양손을 얼굴 앞으로 올립니다.\n\n자세를 세우는 순간 마음도 함께 세워집니다.\n당신은 오늘 잘하려고 온 것이 아닙니다.\n오늘 조금 더 나아지려고 왔습니다.",
    },
    {
      id: 7,
      start: 90,
      ...
      title: "첫 번째 리듬",
      guide: "짧게 내쉬고, 첫 동작을 상상합니다.",
      narration:
        "짧게 숨을 내쉽니다.\n첫 잽이 나갑니다.\n빠르게 나갔다가 다시 돌아옵니다.\n\n큰 변화는 아닐 수 있습니다.\n하지만 당신은 압니다.\n방금 전보다 몸이 조금 더 깨어났다는 것을.",
    },
    {
      id: 8,
      start: 105,
      ...
      title: "땀이 감정을 바꾼다",
      guide: "땀이 흐르는 감각을 상상합니다.",
      narration:
        "한 번 더 움직입니다.\n다시 한 번 더 움직입니다.\n숨이 차오르고, 땀이 흐릅니다.\n\n그런데 이상하게 마음은 조금 가벼워집니다.\n오늘의 스트레스가\n몸의 리듬 속에서 천천히 풀려나갑니다.",
    },
    {
      id: 9,
      start: 120,
      ...
      title: "복싱 매니아가 되는 나",
      guide: "몇 달 뒤의 자신을 떠올립니다.",
      narration:
        "몇 달 뒤의 당신을 떠올립니다.\n퇴근 후 자연스럽게 운동 가방을 챙깁니다.\n\n좋은 글러브를 고르고,\n복싱 영상을 찾아보고,\n다음 훈련이 기다려집니다.\n\n복싱은 어느새 당신의 즐거운 취미가 되었습니다.",
    },
    {
      id: 10,
      start: 135,
      ...
      title: "복싱인이 되는 나",
      guide: "복싱이 삶의 태도가 된 모습을 봅니다.",
      narration:
        "조금 더 시간이 흐릅니다.\n당신은 이제 기술만 따라 하는 사람이 아닙니다.\n\n거리, 호흡, 타이밍, 자세의 의미를\n조금씩 이해합니다.\n\n복싱은 몸을 바꾸고, 하루를 바꾸고,\n당신이 자신을 대하는 방식을 바꿉니다.",
    },
    {
      id: 11,
      start: 150,
      ...
      title: "누군가의 시작이 되는 나",
      guide: "새로 온 회원을 따뜻하게 바라보는 자신을 상상합니다.",
      narration:
        "어느 날, 처음 온 회원이\n어색한 표정으로 서 있습니다.\n\n당신은 그 마음을 압니다.\n당신도 그랬기 때문입니다.\n\n그래서 조용히 웃으며 말합니다.\n처음엔 다 어렵습니다.\n그래도 오늘 한 번만 해보면 됩니다.",
    },
    {
