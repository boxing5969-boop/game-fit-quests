...
const SELECTOR_LABELS: Record<string, string> = {
  ...
  '[data-tour="diet-habit-score"]': "153다이어트 — 오늘의 습관 점수",
  '[data-tour="diet-milestones"]': "153다이어트 — 7/14/21일 마일스톤",
  '[data-tour="diet-nav-value"]': "다이어트 메뉴 — 과학·원리",
  '[data-tour="diet-nav-meal-plan"]': "다이어트 메뉴 — 21일 식단",
  '[data-tour="diet-nav-progress"]': "다이어트 메뉴 — 진행 현황",
  '[data-tour="diet-nav-food"]': "다이어트 메뉴 — 음식 가이드",
  '[data-tour="diet-nav-photos"]': "다이어트 메뉴 — 내 사진",
  '[data-tour="diet-nav-ranking"]': "다이어트 메뉴 — 습관 랭킹",
  '[data-tour="diet-nav-auto-meals"]': "다이어트 메뉴 — 자동 식단",
  '[data-tour="diet-nav-after-21"]': "다이어트 메뉴 — 21일 이후",
  '[data-tour="diet-nav-post-program"]': "다이어트 메뉴 — 유지·연장",
  '[data-tour="diet-page-value"]': "다이어트 페이지 — 과학·원리",
  '[data-tour="diet-page-meal-plan"]': "다이어트 페이지 — 21일 식단",
  '[data-tour="diet-page-food"]': "다이어트 페이지 — 음식 가이드",
  '[data-tour="diet-page-progress"]': "다이어트 페이지 — 진행 현황",
  '[data-tour="diet-page-ranking"]': "다이어트 페이지 — 습관 랭킹",
  '[data-tour="diet-page-auto-meals"]': "다이어트 페이지 — 자동 식단",
  '[data-tour="diet-page-photos"]': "다이어트 페이지 — 내 사진",
  '[data-tour="diet-page-after-21"]': "다이어트 페이지 — 21일 이후",
