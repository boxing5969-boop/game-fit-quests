...
const DAY_6_STEPS: TutorialCampStep[] = [
  ...
  // ── 17. 5가지 습관 개요 (center) ──
  {
    ...
    step: 17,
    route: "/diet",
    targetKey: "day6.habits_intro",
    targetSelector: "",
    title: "매일 체크하는 5가지 습관",
    body: "체중 측정 대신, 매일 5가지 작은 습관을 체크해요.\n하나씩 짧게 소개할게요.",
    osamiMessage: "큰 결심 대신 작은 다섯 번이에요.",
    actionType: "read",
    requireTargetClick: false,
    allowNextWithoutClick: true,
    animation: "spotlight",
    ...
    helperMessage: "잠깐 읽어보세요.",
    successMessage: "첫 번째 습관 — 단백질 먼저.",
    completionRule: "manual_confirm",
  },
  // ── 18. 습관 1 — 단백질 먼저 (center) ──
  {
    day: 6,
    step: 18,
    route: "/diet",
    targetKey: "day6.habit_protein",
    targetSelector: "",
    title: "🥩 단백질을 먼저",
    body: "한 끼에서 단백질(고기 · 생선 · 두부 · 계란)을 먼저 먹어요.\n포만감이 빨리 오고 군것질이 줄어요.",
    osamiMessage: "단백질 한 입 먼저.",
    actionType: "read",
    requireTargetClick: false,
    allowNextWithoutClick: true,
    animation: "spotlight",
    placement: "center",
    fallbackText: "한 끼의 시작은 단백질 한 입이에요.",
    completionText: "단백질을 먼저.",
    helperMessage: "잠깐 읽어보세요.",
    successMessage: "두 번째 — 채소는 자연식으로.",
    completionRule: "manual_confirm",
  },
  // ── 19. 습관 2 — 채소 자연식 (center) ──
  {
    day: 6,
    step: 19,
    route: "/diet",
    targetKey: "day6.habit_veggies",
    targetSelector: "",
    title: "🥬 채소는 자연식으로",
    body: "채소는 튀김·소스 범벅보다 자연 그대로 먹어요.\n생채소 · 데친 채소 · 구운 채소 — 그게 진짜 채소예요.",
    osamiMessage: "채소 본연의 맛이 보여요.",
    actionType: "read",
    requireTargetClick: false,
    allowNextWithoutClick: true,
    animation: "spotlight",
    placement: "center",
    fallbackText: "채소는 가공되지 않은 자연 상태가 좋아요.",
    completionText: "자연식이 진짜 채소예요.",
    helperMessage: "잠깐 읽어보세요.",
    successMessage: "세 번째 — 가당 음료 피하기.",
    completionRule: "manual_confirm",
  },
  // ── 20. 습관 3 — 가당 음료 피하기 (center) ──
  {
    day: 6,
    step: 20,
    route: "/diet",
    targetKey: "day6.habit_drinks",
    targetSelector: "",
    title: "🥤 가당 음료 피하기",
    body: "주스 · 탄산 · 카페 라떼 시럽 — 액체 설탕이 가장 빠르게 살이 돼요.\n물 · 무가당 차로 바꾸면 그것만으로도 큰 변화가 와요.",
    osamiMessage: "한 잔의 차이가 커요.",
    actionType: "read",
    requireTargetClick: false,
    allowNextWithoutClick: true,
    animation: "spotlight",
    placement: "center",
    fallbackText: "단 음료를 줄이면 21일 변화가 더 잘 보여요.",
    completionText: "물·무가당 차로 바꿔봐요.",
    helperMessage: "잠깐 읽어보세요.",
    successMessage: "네 번째 — 야식 피하기.",
    completionRule: "manual_confirm",
  },
  // ── 21. 습관 4 — 야식 피하기 (center) ──
  {
    day: 6,
    step: 21,
    route: "/diet",
    targetKey: "day6.habit_late_night",
    targetSelector: "",
    title: "🌙 야식 피하기",
    body: "잠들기 3시간 전부터는 가볍게 — 위가 쉬어야 다음 날이 가벼워요.\n배고프면 따뜻한 물 한 잔으로 달래봐요.",
    osamiMessage: "위도 잠을 자야 해요.",
    actionType: "read",
    requireTargetClick: false,
    allowNextWithoutClick: true,
    animation: "spotlight",
    placement: "center",
    fallbackText: "취침 전 3시간은 위를 쉬게 해줘요.",
    completionText: "야식보다 따뜻한 물 한 잔.",
    helperMessage: "잠깐 읽어보세요.",
    successMessage: "다섯 번째 — 153복싱짐 출석.",
    completionRule: "manual_confirm",
  },
  // ── 22. 습관 5 — 153복싱짐 출석 (center) ──
  {
    day: 6,
    step: 22,
    route: "/diet",
    targetKey: "day6.habit_attendance",
    targetSelector: "",
    title: "🥊 153복싱짐 출석",
    body: "운동과 식단은 한 짝이에요.\n주 3~4회 153복싱짐에 와서 한 라운드만 뛰어도 21일이 달라져요.",
    osamiMessage: "와주는 것만으로도 절반이에요.",
    actionType: "read",
    requireTargetClick: false,
    allowNextWithoutClick: true,
    animation: "spotlight",
    placement: "center",
    fallbackText: "153복싱짐 출석이 다이어트 5번째 습관이에요.",
    completionText: "출석은 가장 든든한 습관이에요.",
    helperMessage: "잠깐 읽어보세요.",
    successMessage: "마지막은 다이어트 마음가짐이에요.",
    completionRule: "manual_confirm",
  },
  // ── 23. 다이어트 마음가짐 (center — 가치) ──
  {
    day: 6,
    step: 23,
    route: "/diet",
  ...
  // ── 24. Day 6 완료 ──
  {
    ...
    targetSelector: "",
    title: "Day 6 완료",
    body: "153다이어트의 9개 화면 중 핵심 5개와 매일 만나는 5가지 습관까지\n모두 둘러봤어요. 건강은 매일의 작은 한 번이에요.\n내일은 마지막 날, 가이드를 만나요.",
