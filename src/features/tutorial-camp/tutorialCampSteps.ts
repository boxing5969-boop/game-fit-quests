...
const DAY_7_STEPS: TutorialCampStep[] = [
  ...
  // ── 15. 가이드는 자료실 (center) ──
  {
    ...
    targetSelector: "",
    title: "가이드는 자료실이에요",
    body: "외울 필요 없어요.\n궁금한 게 생길 때마다 여기로 와서 그 탭을 펼치면 돼요.\n계속 자라는 자료실, 회원과 함께 천천히 채워가는 책이에요.",
    osamiMessage: "필요할 때 펼쳐 보면 돼요.",
    actionType: "read",
    requireTargetClick: false,
    allowNextWithoutClick: true,
    animation: "spotlight",
    placement: "center",
    fallbackText: "가이드는 마이복서153의 자료실이에요.",
    completionText: "외우지 말고, 필요할 때 펼쳐요.",
    helperMessage: "잠깐 읽어보세요.",
  ...
  // ── 16. 7일 회고 (center) ──
  {
    ...
    targetSelector: "",
    title: "함께 걸어온 7일",
    body: "Day 1 153챌린지 → Day 2 훈련 → Day 3 단증혜택 → Day 4 마인드셋\nDay 5 랭크업 → Day 6 다이어트 → Day 7 가이드.\n마이복서153 의 모든 자리를 함께 둘러봤어요.",
    osamiMessage: "7일 동안 같이 와줘서 고마워요.",
    actionType: "read",
    requireTargetClick: false,
    allowNextWithoutClick: true,
    animation: "spotlight",
    placement: "center",
    fallbackText: "7일 캠프의 모든 단계를 함께 둘러봤어요.",
    completionText: "함께 걸어온 7일이에요.",
    helperMessage: "잠깐 읽어보세요.",
  ...
  // ── 17. 가치 1 — 자기 페이스 (center) ──
  {
    ...
    targetSelector: "",
    title: "약속 ① 자기 페이스로",
    body: "옆 사람 속도가 아니라 내 속도예요.\n오늘 한 줄, 내일 두 줄 — 자기 페이스로 가는 사람이 결국 멀리 가요.",
    osamiMessage: "비교하지 말고, 비교 당하지도 말아요.",
    actionType: "read",
    requireTargetClick: false,
    allowNextWithoutClick: true,
    animation: "spotlight",
    placement: "center",
    fallbackText: "마이복서153 은 자기 페이스를 가장 소중히 여겨요.",
  ...
  // ── 18. 가치 2 — 비교 아닌 동행 (center) ──
  {
    ...
    targetSelector: "",
    title: "약속 ② 비교가 아니라 동행",
    body: "랭킹은 이기라고 만들어둔 게 아니에요.\n같은 153 회원들이 어떻게 오늘을 보내는지 보며 같이 가는 자리예요.\n혼자 가는 것보다 같이 가면 멀리 가요.",
    osamiMessage: "보낸 응원이 결국 돌아와요.",
    actionType: "read",
    requireTargetClick: false,
    allowNextWithoutClick: true,
    animation: "spotlight",
    placement: "center",
    fallbackText: "랭킹과 커뮤니티는 비교 아닌 동행을 위해 만들어졌어요.",
    completionText: "같이 가면 멀리 가요.",
    helperMessage: "잠깐 읽어보세요.",
  ...
  // ── 19. 가치 3 — 다시 돌아오는 횟수 (center) ──
  {
    ...
    targetSelector: "",
    title: "약속 ③ 다시 돌아오는 횟수",
    body: "완벽하게 한 번이 아니라, 다시 돌아오는 열 번이에요.\n며칠 쉬어도 괜찮아요. 오늘 다시 돌아오는 것 — 그게 가장 큰 힘이에요.\n오삼이는 매일 짧게 곁에 있을게요.",
    osamiMessage: "다시 돌아오는 사람이 결국 바뀌어요.",
    actionType: "read",
    requireTargetClick: false,
    allowNextWithoutClick: true,
    animation: "spotlight",
    placement: "center",
    fallbackText: "마이복서153 은 완벽함이 아닌 꾸준함을 봅니다.",
    completionText: "다시 돌아오는 사람이 결국 바뀌어요.",
    helperMessage: "잠깐 읽어보세요.",
  ...
  // ── 20. 가치 4 — 작은 한 번 (center) ──
  {
    ...
    targetSelector: "",
    title: "약속 ④ 작은 한 번이 만드는 것",
    body: "오늘의 한 잽, 오늘의 한 줄 일기, 오늘의 한 끼.\n작은 한 번이 쌓여 한 달이 되고, 한 단계가 되고, 결국 당신이 돼요.\n크게 결심하지 않아도 돼요. 오늘 한 번이면 충분해요.",
    osamiMessage: "오늘 한 번이 결국 당신이에요.",
    actionType: "read",
    requireTargetClick: false,
    allowNextWithoutClick: true,
    animation: "spotlight",
    placement: "center",
    fallbackText: "마이복서153 은 매일의 작은 한 번을 가장 소중히 여겨요.",
  ...
  // ── 21. 가치 5 — 나를 다시 좋아하기 (center) ──
  {
    ...
    targetSelector: "",
    title: "약속 ⑤ 나를 다시 좋아하는 시간",
    body: "복싱은 강해지는 시간이기도 하지만,\n나를 다시 좋아하게 되는 시간이기도 해요.\n이 앱이 그 시간을 만들어주는 자리이길 바랍니다.",
    osamiMessage: "당신이 당신을 다시 좋아하길.",
    actionType: "read",
    requireTargetClick: false,
    allowNextWithoutClick: true,
    animation: "spotlight",
    placement: "center",
    fallbackText: "마이복서153 의 핵심 가치 — 자기 자신과 다시 가까워지는 시간.",
    completionText: "복싱은 나를 다시 좋아하게 되는 시간이에요.",
    helperMessage: "잠깐 읽어보세요.",
