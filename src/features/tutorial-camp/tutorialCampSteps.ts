...
const DAY_1_STEPS: TutorialCampStep[] = [
  ...
  // ── 2. 복싱 IQ 모달: 정답 선택 ──
  //   targetSelector = 회원이 누른 button (selected). 처음엔 매칭 X (fallback)
  //   → tooltip 만 표시. 회원이 button 누름 → selected 부여 → spotlight 가
  //   그 button 으로 좁아짐. autoAdvance X — 회원이 직접 '다음으로'.
  {
    day: 1,
    step: 2,
    route: "/myboxer/quest",
    targetKey: "day1.boxing_iq_answer",
    targetSelector: '[data-tour="boxing-iq-selected-option"]',
    title: "정답을 선택하세요",
    body: "답이라고 생각하는 선택지를\n한 번 눌러보세요.",
  ...
  // ── 5. 챔피언 일기 카드 클릭 (153 QUEST 자동 이동) ──
  {
    day: 1,
    step: 5,
    route: "/myboxer/quest",
  ...
  // ── 6. 일기 모달: 질문 바꾸기 (랜덤 질문 선택) ──
  {
    day: 1,
    step: 6,
    route: "/myboxer/quest",
    targetKey: "day1.journal_prompt",
    targetSelector: '[data-tour="journal-prompt-list"]',
    title: "질문을 하나 골라볼까요?",
    body: "여기서 마음에 드는 질문 하나를\n한 번 눌러보세요.",
    osamiMessage: "정답은 없어요. 끌리는 질문이면 돼요.",
    actionType: "wait_select_option",
    requireTargetClick: false,
    allowNextWithoutClick: true,
    animation: "spotlight",
    placement: "bottom",
    fallbackText: "일기 시트 안에 질문 바꾸기 영역이 있어요.",
    completionText: "질문이 정해졌어요.",
    helperMessage: "질문 하나를 눌러보세요.",
    successMessage: "좋아요. 이제 한 줄 적어볼게요.",
    blockNextUntilComplete: true,
    completionRule: "option_selected",
    optionSelector: '[data-tutorial-prompt="true"]',
    autoAdvance: true,
  },
  // ── 7. 일기 모달: 한 줄 회고 입력 ──
  {
    ...
    step: 7,
    route: "/myboxer/quest",
    targetKey: "day1.journal_input",
    targetSelector: '[data-tour="journal-reflection-input"]',
    title: "한 줄만 적어볼까요?",
    body: "5자만 넘으면 돼요.\n부담 없이 짧게 적어보세요.",
    osamiMessage: "거창하지 않아도 충분해요.",
    ...
    completionText: "잘 적으셨어요.",
    helperMessage: "한 줄만 적어도 충분해요. 5자 이상이면 다음으로 갈 수 있어요.",
    successMessage: "이제 컨디션을 골라볼게요.",
    blockNextUntilComplete: true,
  ...
  // ── 8. 일기 모달: 컨디션 선택 ──
  {
    ...
    step: 8,
    route: "/myboxer/quest",
    targetKey: "day1.journal_condition",
  ...
  // ── 9. 일기 모달: 기록 남기기 버튼 ──
  {
    ...
    step: 9,
    route: "/myboxer/quest",
    targetKey: "day1.journal_submit",
    targetSelector: '[data-tour="journal-submit"]',
    title: "기록 남기기",
    body: "다 적었으면 여기를 눌러주세요.",
    osamiMessage: "오늘의 한 줄, 잘 남겼어요.",
    actionType: "click",
    requireTargetClick: true,
    allowNextWithoutClick: true,
    animation: "spotlight",
    placement: "top",
    fallbackText: "일기 시트 하단의 '기록 남기기' 버튼을 눌러주세요.",
    completionText: "오늘의 기록이 저장됐어요.",
    helperMessage: "여기 '기록 남기기' 를 눌러보세요.",
    successMessage: "잘했어요. Day 1 마무리해볼게요.",
    blockNextUntilComplete: true,
    completionRule: "target_clicked",
    autoAdvance: true,
  },
...
const DAY_3_STEPS: TutorialCampStep[] = [
  ...
  },
  {
    ...
    step: 2,
    route: "/myboxer/quest",
    targetKey: "day3.boxing_iq_question",
    targetSelector: '[data-tour="boxing-iq-question"]',
    title: "문제를 먼저 읽어볼까요?",
    body: "위에 오늘의 문제가 보여요.\n천천히 읽어보고 '다음으로' 를 눌러주세요.",
    osamiMessage: "급하게 풀지 않아도 괜찮아요. 읽는 것부터 시작이에요.",
    actionType: "read",
    requireTargetClick: false,
    allowNextWithoutClick: true,
    animation: "pulse",
    placement: "bottom",
    fallbackText:
      "복싱 IQ 모달이 열려 있으면 위쪽의 문제 영역을 한 번 읽어보세요.",
    completionText: "잘 읽으셨어요. 이제 답을 골라볼게요.",
  ...
  },
  {
    ...
    helperMessage: "답이라고 생각하는 선택지를 한 번 눌러보세요.",
    successMessage: "좋아요. 모달을 닫으면 다음으로 갑니다.",
    blockNextUntilComplete: true,
    completionRule: "quiz_answer_selected",
    expectedAnswerSelector: '[data-tutorial-answer="true"]',
    autoAdvance: true,
