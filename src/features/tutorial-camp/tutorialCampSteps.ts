...
const DAY_1_STEPS: TutorialCampStep[] = [
  ...
  // ── 1. 153 챌린지 킹 보드 (출석왕·버피왕 …) ──
  {
    ...
    title: "이번 주 왕좌는 누구?",
    body: "출석왕·앱활동왕·닉네임왕·버피왕처럼 8개 왕좌가 있어요.\n버튼을 누르면 규칙과 순위가 열려요. 한 번 눌러볼까요?",
    osamiMessage: "내 순위가 어디쯤인지 보여요.",
    actionType: "click",
    requireTargetClick: true,
    allowNextWithoutClick: true,
    animation: "spotlight",
    placement: "bottom",
    fallbackText: "153 챌린지 화면 위쪽에 왕좌 버튼 8개가 있어요.",
    completionText: "왕좌를 열어봤어요.",
    helperMessage: "왕좌 버튼 하나를 눌러보세요.",
