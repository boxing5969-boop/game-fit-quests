...
const SELECTOR_LABELS_LITE: Record<string, string> = {
  ...
  '[data-tour="cert-detail-accordions"]': "단증혜택 — 실제 가점 상세",
  ...
  '[data-tour="mindset-start-button"]': "153마인드셋 — 시작 버튼",
  ...
  '[data-tour="diet-onboarding-start"]': "153다이어트 — 온보딩 시작 버튼",
  ...
  '[data-tour="guide-onboarding-replay"]': "가이드 — 온보딩 다시 보기",
};
