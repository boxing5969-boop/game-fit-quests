...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  },
  {
    key: "first_challenge",
    order: 5,
    label: "5단계 — 더 다이어터 챌린지 둘러보기",
    description:
      "혼자가 아니라 함께. '더 다이어터' 시즌 챌린지 페이지에서 어떤 도전들이 진행 중인지 한 번 둘러보세요. 5초만 머물러도 자동 완료.",
    hint: "더 다이어터 시즌 페이지에서 위에서 아래까지 어떤 챌린지가 있는지 가볍게 훑어봐주세요. 마음에 드는 게 있으면 카드 하나 눌러봐도 좋아요.",
    ctaLabel: "더 다이어터 챌린지 보기",
