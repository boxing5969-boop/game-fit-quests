...
export const FAQ_ITEMS = [
  ...
  {
    q: "왜 자가 도전이 더 좋은 보상을 받나요?",
    a: "자가 도전은 회원의 적극적인 참여를 장려합니다. 레벨업 진행은 동일하지만, 자가 도전 시 보너스 +20XP와 연속 기록 등 추가 보상을 제공합니다.",
  },
  {
    q: "왜 코치 백업 모드가 있나요?",
    a: "모든 회원이 프로그램에 빠짐없이 참여하도록 보장합니다. 자가 도전을 하지 않은 회원도 코치가 빠르게 확인하여 진행도를 기록합니다.",
  },
  {
