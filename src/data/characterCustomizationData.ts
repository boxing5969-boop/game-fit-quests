...
const TITLE_OPTIONS: CustomizationOption[] = [
  ...
  { key: "rookie_challenger", label: "신입 챌린저",         price: 0,      league: "white", rarity: "common",    description: "튜토리얼을 마친 신입 챌린저 — 5미션 완료 보상" },
...
const AURA_OPTIONS: CustomizationOption[] = [
  ...
  // 👑 Legend
  { key: "halo_rainbow_master", label: "레인보우 마스터 오라",  price: 240000, league: "legend", rarity: "legendary", description: "무지개 파장이 캐릭터를 감싸는 최상위 오라 (오라 카테고리)", requirement: "hall_of_fame" },
