...
const WHITE_FAQ = [
  ...
  { q: "왜 자가 도전이 더 좋은 보상을 받나요?", a: "자가 도전은 회원의 적극적인 참여를 장려합니다. 레벨업 진행은 동일하지만, 자가 도전 시 보너스 XP와 연속 기록 등 추가 보상을 제공합니다." },
  { q: "왜 코치 백업 모드가 있나요?", a: "모든 회원이 프로그램에 빠짐없이 참여하도록 보장합니다. 자가 도전을 하지 않은 회원도 코치가 빠르게 확인하여 진행도를 기록합니다." },
  { q: "왜 화이트 1~3은 쉬우면서도 반복적인가요?", a: "초기 단계는 운동 습관 형성이 가장 중요합니다. 쉽지만 반복을 통해 기초체력과 자세를 자연스럽게 몸에 익히는 구간입니다." },
  { q: "왜 레벨업은 공정하게 같고, 보너스는 다를 수 있나요?", a: "레벨업 조건(XP, 세션, 출석)은 자가 도전이든 코치 백업이든 동일합니다. 하지만 적극적으로 참여하는 회원에게 추가 보너스를 제공하여 자발적 참여 문화를 만듭니다." },
