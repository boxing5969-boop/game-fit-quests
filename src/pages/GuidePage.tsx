...
const ScienceTab = () => (
  <div className="space-y-3 animate-slide-up">
    <p className="text-xs text-muted-foreground mb-2">
      WHO·CDC·ACSM 권고안을 참고해 설계된 프로그램입니다.
    </p>
              ...
              <div className="border-t border-border px-3 pb-3">
                {levels.map(lv => {
                  ...
                  return (
                    <div
                      key={lv.level}
                      className={`mt-2 rounded-xl p-3 transition-all ${
                    ...
                    >
                      <div className="mb-1 flex items-center justify-between">
                        ...
                        <span className="rounded-full bg-accent/10 px-2 py-0.5 text-[9px] font-bold text-accent-foreground">
                          🔓 {lv.unlockedBenefit}
                        </span>
                      </div>
